...
Two primary techniques to reduce the interdependencies between components:

1. dependency injection
->
Allows a component to receive its dependencies from an external source
rather than creating them, making it easier to swap or mock these dependencies.

2. the observer pattern
->
Allows an object to publish changes to its state so that other objects
